...
<header class="px-3 px-md-8 py-5 position-absolute top-0 d-flex justify-content-between align-items-center w-100 z-1">
  ...
  <ul class="list-inline mb-0">
    <li class="list-inline-item pe-4 border-end"><a href="index.html" class="link-body-emphasis">Sample</a></li>
    <li class="list-inline-item pe-4 border-end"><a href="#!" class="link-body-emphasis">Sample</a></li>
    <li class="list-inline-item"><a href="#!" class="link-body-emphasis">Sample</a></li>
  </ul>
</header>
